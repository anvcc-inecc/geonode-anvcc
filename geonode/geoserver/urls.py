...
urlpatterns = [  # 'geonode.geoserver.views',
    ...
    re_path(r"^(?P<layername>[^/]*)/style$", views.dataset_style, name="dataset_style"),
    re_path(r"^(?P<layername>[^/]*)/style/upload$", views.dataset_style_upload, name="dataset_style_upload"),
    re_path(r"^(?P<layername>[^/]*)/style/manage$", views.dataset_style_manage, name="dataset_style_manage"),
    re_path(r"^acls/?$", views.dataset_acls, name="dataset_acls"),
    re_path(r"^resolve_user/?$", views.resolve_user, name="dataset_resolve_user"),
